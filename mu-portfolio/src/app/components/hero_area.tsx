        ...
        <>
            <div className="bg-gray-900 overflow-hidden">
                <header className="absolute inset-x-0 top-0 z-50">
                    <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
                        ...
                        <div className="hidden  justify-center lg:flex lg:gap-x-12 mx-10">
                            <a href="#aboutMe" className="text-sm font-light leading-6 tracking-wider text-white hover:text-teal-300 active:text-purple-400 focus:text-pink-300">About me</a>
                            <a href="#projects" className="text-sm font-light leading-6 tracking-wider text-white hover:text-teal-300 active:text-purple-400 focus:text-pink-300">Projects</a>
                            <a href="#contacts" className="text-sm font-light leading-6 tracking-wider text-white hover:text-teal-300 active:text-purple-400 focus:text-pink-300">Contacts</a>
                    ...
                    <div className="hidden" role="dialog" aria-modal="true">
                        ...
                        <div className="fixed inset-y-0 right-0 z-50 w-full overflow-y-auto bg-gray-900 px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-white/10">
                            <div className="flex items-center justify-between">
                                <a href="#" className="-m-1.5 p-1.5">
                                    <span className="sr-only">Your Company</span>
                                    <Image src="" className="h-8 w-auto" alt="" />
                                </a>
                            ...
                            <div className="mt-6 flow-root">
                                <div className="-my-6 divide-y divide-gray-500/25">
                                    <div className="space-y-2 py-6">
                                        <a href="#aboutMe" className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-gray-800">About me</a>
                                        <a href="#projects" className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-gray-800">Projects</a>
                                        <a href="#contacts" className="-mx-3 block rounded-lg px-3 py-2 text-base font-semibold leading-7 text-white hover:bg-gray-800">Contacts</a>
                ...
                <div className="relative isolate pt-14">
                    <Image src={heroBG} alt="" className="absolute inset-0 -z-10 w-full h-full object-cover" />
