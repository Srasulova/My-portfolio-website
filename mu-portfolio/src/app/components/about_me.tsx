                ...
                <div className="mx-auto max-w-7xl px-6 lg:px-8">
                    <div className="mx-auto flex max-w-2xl flex-col items-center justify-between gap-16 lg:mx-0 lg:max-w-none lg:flex-row h-auto" >
                        ...
                        <div className="w-full lg:max-w-xl lg:flex-auto">
                            ...
                            <p className="mb-4 text-zinc-700">Born and raised in the picturesque landscapes of Azerbaijan, I&apos;m Sabina, a proud Azerbaijani soul now navigating the American adventure with my greatest joy — my family and a charming baby girl. </p>

                            <p className="mb-4  text-zinc-700">For more than 15 years, I waltzed through the realms of customer service, but the thrill started to fade. Seeking a new chapter, I took a leap into the unknown and found my passion in web development. A fresh face in the web development world, I&apos;m eagerly embracing the journey, building websites, applications, and anything that involves code. Still got a long road ahead, and I must admit, it&apos;s one exciting learning curve.</p>
