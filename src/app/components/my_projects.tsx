...
export default function MyProjects() {
    return (
        <>
            <div className="bg-white my-14 py-6 sm:my-28" id="projects">
                        ...
                        <article className="flex flex-col items-start justify-between calculator">
                            ...
                            <div className="max-w-xl">
                                <div className="mt-8 flex items-center gap-x-4 text-xs">
                                    <a href="#" className="goLive relative z-10 rounded-full bg-gray-50 px-3 py-1.5 font-medium text-gray-600 hover:bg-rose-100 flex items-center gap-1">
                                    ...
                                    <a href="https://github.com/Srasulova/basic_calculator" className="github relative z-10 rounded-full bg-gray-50 px-3 py-1.5 font-medium text-gray-600 hover:bg-teal-100 flex items-center gap-1">
                                        <i>
                        ...
                        <article className="flex flex-col items-start justify-between piggyBank">
                            ...
                            <div className="max-w-xl">
                                <div className="mt-8 flex items-center gap-x-4 text-xs">
                                    ...
                                    <a href="https://github.com/Srasulova/Piggy-Bank" className="github relative z-10 rounded-full bg-gray-50 px-3 py-1.5 font-medium text-gray-600 hover:bg-teal-100 flex items-center gap-1">
                                        <i>
                                            <Image src={githubIcon} alt="github icon" className="w-5 h-5" />
                                        </i> Check out the code in Github</a>
                                </div>
                        ...
                        <article className="flex flex-col items-start justify-between palindrome">
                            ...
                            <div className="max-w-xl">
                                <div className="mt-8 flex items-center gap-x-4 text-xs">
                                    ...
                                    <a href="https://github.com/Srasulova/Palindrome-checker" className="github relative z-10 rounded-full bg-gray-50 px-3 py-1.5 font-medium text-gray-600 hover:bg-teal-100 flex items-center gap-1">
                                        <i>
                                            <Image src={githubIcon} alt="github icon" className="w-5 h-5" />
                                        </i> Check out the code in Github</a>
                                </div>
                        ...
                        <article className="flex flex-col items-start justify-between todoApp">
                            ...
                            <div className="max-w-xl">
                                <div className="mt-8 flex items-center gap-x-4 text-xs">
                                    ...
                                    <a href="https://github.com/Srasulova/ToDO-app" className="relative z-10 rounded-full bg-gray-50 px-3 py-1.5 font-medium text-gray-600 hover:bg-teal-100 flex items-center gap-1">
                                        <i>
                                            <Image src={githubIcon} alt="github icon" className="w-5 h-5" />
                                        </i> Check out the code in Github</a>
                                </div>
